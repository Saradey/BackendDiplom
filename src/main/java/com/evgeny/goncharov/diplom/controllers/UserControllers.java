...
public class UserControllers {
    ...
    public ResponseEntity<BaseResponse> registrationUser(@RequestBody RequestRegUser user) throws UserWasException {
    ...
    public ResponseEntity<BaseResponse> authorizationUser(@RequestBody RequestBase requestBase){
